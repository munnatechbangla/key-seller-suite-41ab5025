...
-- 3. Fulfillment RPC Sync (Final check for parameter names)
-- The error "Property 'items' does not exist" suggests functions might be returning the wrong shape
-- or the client code expects an object with 'items' property but getting an array.
