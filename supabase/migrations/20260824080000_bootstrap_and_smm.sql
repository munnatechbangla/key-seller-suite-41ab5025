...
CREATE TABLE IF NOT EXISTS public.order_items (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  order_id uuid NOT NULL, -- Simplified for bootstrap
...
-- 6. Setup State (Required by admin-tools)
...
-- 7. Site Settings (Required by admin-settings)
...
-- 9. Add missing columns for build compatibility in Recent Purchases
