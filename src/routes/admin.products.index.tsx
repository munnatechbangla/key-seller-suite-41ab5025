  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div>
          <h1 className="text-2xl font-bold">'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Debug the current live-site loading failure.\n\nThe homepage is showing the application's generic error page:\n\"This page didn't load\"\n\"Something went wrong on our end.\"\n\nDo not search for this text in the codebase. It is an error-boundary message, not the root error.\n\nPlease trace the actual runtime error that triggers the error boundary during the initial homepage load.\n\nCheck:\n\nRoot route loader\n\nHomepage data fetching\n\nServer functions used by the homepage\n\nSupabase requests made during initial load\n\nRecent SMM-related changes that may affect shared catalog/product queries\n\nBrowser/server runtime errors\n\nFind the FIRST real error in the failure chain and fix only that specific cause.\n\nDo not add features.\nDo not modify the SMM workflow.\nDo not reset or recreate existing data.\nDo not make broad refactors.\n\nAfter fixing, verify that the homepage can load normally and that the error boundary is no longer triggered.\n\nReport the actual root error and the specific fix made.</h1>
