  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div>
          <h1 className="text-2xl font-bold">'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            The live homepage is still failing with the generic error page:\n\n\"This page didn't load\"\n\"Something went wrong on our end.\"\n\nThe previous change only modified Admin Products display text and did not fix this issue.\n\nDo not modify any UI text.\n\nPlease inspect the actual runtime error triggered during the initial homepage load and identify the first failing request, loader, server function, component, or database query.\n\nCheck the browser console/server logs and the homepage/root loader execution path.\n\nMake only the minimal fix required for that actual runtime error.\n\nDo not:\n\nchange UI text\n\nadd features\n\ncontinue SMM development\n\nreset or recreate the database\n\ndelete existing data\n\nperform broad refactoring\n\nAfter the fix, verify the live homepage and product pages load successfully.\n\nReport the exact root error and the file/function that caused it.</h1>
